 ...
 * enumeration should be used in conjunction with {@link cn.ideartefact.gson.GsonBuilder} to configure a
 * {@link cn.ideartefact.gson.Gson} instance to properly translate Java field names into the desired
 * JSON field names.
 *
