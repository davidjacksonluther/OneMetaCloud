...
public final class JsonParser {
   ...
   */
  @Deprecated
  @InlineMe(replacement = "JsonParser.parseString(json)", imports = "cn.ideartefact.gson.JsonParser")
   ...
   */
  @Deprecated
  @InlineMe(replacement = "JsonParser.parseReader(json)", imports = "cn.ideartefact.gson.JsonParser")
