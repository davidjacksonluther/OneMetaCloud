...
package cn.ideartefact.gson.annotations;
 ...
 *
 * <p>This annotation will override any {@link cn.ideartefact.gson.FieldNamingPolicy}, including the
 * default field naming policy, that may have been set on the {@link cn.ideartefact.gson.Gson} instance.
 * A different naming policy can set using the {@code GsonBuilder} class. See {@link
 * cn.ideartefact.gson.GsonBuilder#setFieldNamingPolicy(cn.ideartefact.gson.FieldNamingPolicy)} for more
 * information.
 *
 ...
 *
 * @see cn.ideartefact.gson.FieldNamingPolicy
